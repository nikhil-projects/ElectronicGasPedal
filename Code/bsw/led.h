...
* \date <25-09-2018>
*
* \brief <Led basic driver APIs>
*
* detailed description what the file does
* This file provides the basic APIs for LED On, Off and Toggle functionality
*
* \note <notes>
...
*/
 enum eLED_id{
  ...
  LED_ALL       /**< Selection of all LED */
} ;
typedef enum eLED_id LED_select_t;

/**
* \brief Enumeration identifying the state of the LED.
*
*/
enum eLED_ONOFF{
 ...
 * @param LED_select_t ledId - Identifier for the LED, ALL will change all LED's
